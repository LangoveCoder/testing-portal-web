...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-500 to-teal-600">
    <div class="bg-white p-8 rounded-lg shadow-2xl w-full max-w-md">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800">College Admin Portal</h1>
        ...
        <form method="POST" action="{{ route('college.login.post') }}">
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    id="email" 
                    value="{{ old('email') }}"
                    class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-green-500"
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('super-admin.login') }}" class="text-sm text-green-600 hover:text-green-800">
                ← Super Admin Login
            </a>
        </div>
    </div>
