        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-4">
                    ...
                    <h1 class="text-xl font-bold">Seating Plans</h1>
                </div>
                <div class="flex items-center space-x-4">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-6 bg-gradient-to-r from-blue-500 to-blue-600">
                ...
                <p class="text-blue-100 mt-1">View and download hall-wise seating arrangements</p>
            </div>
            ...
            <div class="p-6">
                @if($tests->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Generate roll numbers first to create seating plans.</p>
                    </div>
                @else
