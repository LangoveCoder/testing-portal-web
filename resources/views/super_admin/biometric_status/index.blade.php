...
<div class="min-h-screen bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <form method="GET" action="{{ route('super-admin.biometric-status.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <!-- Search -->
                <div>
                ...
                <div>
                    ...
                    <select name="college_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <select name="test_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                                ...
                                @if($hasFingerprint)
                                    @if($student->fingerprint_image)
                                        <img src="{{ asset('storage/' . $student->fingerprint_image) }}" 
                                             alt="Fingerprint" 
                                             class="w-20 h-20 rounded border-2 border-green-500 mx-auto cursor-pointer hover:scale-150 transition"
                                             onclick="showImageModal(this.src)">
                                    @else
