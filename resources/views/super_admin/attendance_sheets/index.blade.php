        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Attendance Sheets</h1>
                </div>
    ...
    <main class="flex-grow py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        ...
        <div class="bg-white dark:bg-dark-800 rounded-2xl shadow-lg border border-gray-200 dark:border-dark-700 overflow-hidden">
            <div class="p-6 bg-gradient-to-r from-teal-500 to-teal-600">
                <div class="flex items-center">
                    <span class="material-icons-outlined text-3xl text-white mr-4">assignment_turned_in</span>
                    <div>
                        <h2 class="text-2xl font-bold text-white">Generate Attendance Sheets</h2>
                        <p class="text-teal-100 mt-1">Hall-wise student lists for marking attendance</p>
                    </div>
                </div>
            </div>
                ...
                @if($tests->isEmpty())
                    <div class="text-center py-12">
                        <div class="w-16 h-16 bg-gray-100 dark:bg-dark-700 rounded-2xl flex items-center justify-center mb-4 mx-auto">
                            <span class="material-icons-outlined text-2xl text-gray-400">assignment_turned_in</span>
                        </div>
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No Tests Available</h3>
                        <p class="text-gray-500 dark:text-gray-400">Generate roll numbers first to create attendance sheets</p>
                    </div>
                @else
                        ...
                        @foreach($tests as $test)
                            <div class="p-6 border-b border-gray-200 dark:border-dark-700 last:border-b-0">
                                <div class="flex items-start justify-between mb-4">
                                    ...
                                    <span class="px-3 py-1 text-sm font-semibold rounded-full bg-teal-100 dark:bg-teal-900/30 text-teal-800 dark:text-teal-300">
                                ...
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="{{ route('super-admin.attendance-sheets.show', $test) }}" 
                                    ...
                                    <a href="{{ route('super-admin.attendance-sheets.download', $test) }}" 
                                       class="inline-flex items-center px-4 py-2 bg-teal-600 hover:bg-teal-700 dark:bg-teal-700 dark:hover:bg-teal-800 text-white font-medium rounded-lg transition-colors">
