        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-4">
                    ...
                    <h1 class="text-xl font-bold">Attendance Sheets</h1>
                </div>
                <div class="flex items-center space-x-4">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-6 bg-gradient-to-r from-green-500 to-green-600">
                ...
                <p class="text-green-100 mt-1">Hall-wise student lists for marking attendance</p>
            </div>
            ...
            <div class="p-6">
                @if($tests->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No Tests Available</h3>
                        <p class="mt-1 text-sm text-gray-500">Generate roll numbers first to create attendance sheets.</p>
                    </div>
                @else
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $test->college->name }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $test->test_date->format('d M Y') }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $test->students()->whereNotNull('roll_number')->count() }}</div>
                                    </td>
