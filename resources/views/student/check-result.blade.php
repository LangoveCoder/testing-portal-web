...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-purple-500 to-pink-600 dark:from-purple-700 dark:to-pink-800 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl w-full">
        <!-- Header Card -->
        <div class="bg-white dark:bg-dark-800 rounded-lg shadow-xl p-8 mb-6 border border-gray-200 dark:border-dark-700">
            <div class="text-center">
                <svg class="mx-auto h-16 w-16 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
