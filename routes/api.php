...
// ============================================
// STUDENT ATTENDANCE APIs (Mobile App)
// ============================================

Route::prefix('attendance')->group(function () {
    Route::post('/student-info', [App\Http\Controllers\Api\StudentAttendanceController::class, 'getStudentInfo']);
    Route::post('/mark', [App\Http\Controllers\Api\StudentAttendanceController::class, 'markAttendance']);
    Route::post('/bulk-mark', [App\Http\Controllers\Api\StudentAttendanceController::class, 'bulkMarkAttendance']);
    Route::put('/update', [App\Http\Controllers\Api\StudentAttendanceController::class, 'updateAttendance']);
    Route::get('/stats', [App\Http\Controllers\Api\StudentAttendanceController::class, 'getAttendanceStats']);
    Route::get('/list', [App\Http\Controllers\Api\StudentAttendanceController::class, 'getAttendanceList']);
});

// ============================================
// ENHANCED BIOMETRIC APIs
// ============================================
...
Route::prefix('biometric')->group(function () {
    ...
    Route::post('fingerprint/validate-quality', [App\Http\Controllers\Api\StudentBiometricController::class, 'validateFingerprintQuality']);
    Route::post('fingerprint/upload-image-base64', [App\Http\Controllers\Api\StudentBiometricController::class, 'uploadFingerprintImageBase64']);
});
...
Route::prefix('sync')->group(function () {
    Route::get('/status', [App\Http\Controllers\Api\OfflineSyncController::class, 'getSyncStatus']);
    Route::post('/queue', [App\Http\Controllers\Api\OfflineSyncController::class, 'queueForSync']);
    Route::post('/process', [App\Http\Controllers\Api\OfflineSyncController::class, 'processPendingSync']);
    Route::delete('/clear-completed', [App\Http\Controllers\Api\OfflineSyncController::class, 'clearCompletedSync']);
});